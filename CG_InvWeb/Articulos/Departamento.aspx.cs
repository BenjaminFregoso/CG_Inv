...
namespace CG_InvWeb.Articulos
{
    public partial class Departamento : System.Web.UI.Page
    {
        ...
        protected void ASPxGridView1_RowInserted(object sender, DevExpress.Web.Data.ASPxDataInsertedEventArgs e)
        {
            ...
            GlobalHandler objeto = new GlobalHandler();
            objeto.Bitacora("INSERT", "", e.NewValues["departamento"].ToString() , usuario, "", "Departamento");
            //TERMINA BITACORA #######################
        }
        ...
        protected void ASPxGridView1_RowDeleted(object sender, DevExpress.Web.Data.ASPxDataDeletedEventArgs e)
        {
            ...
            GlobalHandler objeto = new GlobalHandler();
            objeto.Bitacora("DELETE", e.Values["departamento"].ToString(), "", usuario, "", "Departamento");
            //TERMINA BITACORA #######################
        }
    }
}