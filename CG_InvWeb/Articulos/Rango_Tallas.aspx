<%@ Page Title="Rangos de Tallas" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="Rango_Tallas.aspx.cs" Inherits="CG_InvWeb.Articulos.Rango_Tallas" %>
...
<div class="Principal">          
    <dx:ASPxRoundPanel ID="ASPxRoundPanel1" HorizontalAlign="Left" runat="server" HeaderText="Rangos de Tallas" ShowCollapseButton="True" Theme="MaterialCompact" Width="100%" Font-Names="Century Gothic" CssClass="auto-style1" Height="100%" HeaderNavigateUrl="~/Articulos/Rangos_Tallas.aspx">
        <LoadingPanelStyle HorizontalAlign="Left" VerticalAlign="Top"></LoadingPanelStyle>
        <PanelCollection>
            <dx:PanelContent runat="server">
                <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SDS_RangoTallas" EnableTheming="True" KeyFieldName="key_rango_talla" Theme="MaterialCompact" KeyboardSupport="True" Width="100%" OnRowDeleted="ASPxGridView1_RowDeleted" OnRowInserted="ASPxGridView1_RowInserted" OnRowUpdated="ASPxGridView1_RowUpdated">

                    <EditFormLayoutProperties ColCount="1">
                        <Items>
                            <dx:GridViewColumnLayoutItem ColSpan="1" ColumnName="rango">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="key_rango_talla" ShowInCustomizationForm="True" VisibleIndex="1" Caption="Código" ReadOnly="True">
                            <EditFormSettings Visible="False" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="rango" ShowInCustomizationForm="True" VisibleIndex="2" Caption="Rango">
                            <PropertiesTextEdit MaxLength="50" HelpText="Nombre del rango de la talla (hasta 50 caracteres)" NullText="Rango">
                ...
                <asp:SqlDataSource ID="SDS_RangoTallas" runat="server" ConnectionString="<%$ ConnectionStrings:ServerPostgreSqlODBC %>" DeleteCommand="DELETE FROM &quot;Articulos_tallas_rangos&quot; WHERE key_rango_talla = ?" InsertCommand="INSERT INTO &quot;Articulos_tallas_rangos&quot; (rango) VALUES ( ?)" ProviderName="<%$ ConnectionStrings:ServerPostgreSqlODBC.ProviderName %>" SelectCommand="SELECT key_rango_talla, rango FROM &quot;Articulos_tallas_rangos&quot;" UpdateCommand="UPDATE &quot;Articulos_tallas_rangos&quot; SET rango = ? WHERE key_rango_talla = ?">
                    <DeleteParameters>
                        <asp:Parameter Name="key_rango_talla" Type="Int64" />
                    </DeleteParameters>
                    <InsertParameters>
