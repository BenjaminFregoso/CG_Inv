<%@ Page Title="Características" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="Caracteristicas.aspx.cs" Inherits="CG_InvWeb.Articulos.Caracteristicas" %>
...
<div class="Principal">          
    <dx:ASPxRoundPanel ID="ASPxRoundPanel1" HorizontalAlign="Left" runat="server" HeaderText="Características" ShowCollapseButton="True" Theme="MaterialCompact" Width="100%" Font-Names="Century Gothic" CssClass="auto-style1" Height="100%" HeaderNavigateUrl="~/Articulos/Caracteristicas.aspx">
        <LoadingPanelStyle HorizontalAlign="Left" VerticalAlign="Top"></LoadingPanelStyle>
        <PanelCollection>
            <dx:PanelContent runat="server">
                <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EnableTheming="True" KeyFieldName="key_caracteristicas" Theme="MaterialCompact" KeyboardSupport="True" Width="100%">

                    <EditFormLayoutProperties ColCount="1">
                        <Items>
                            <dx:GridViewColumnLayoutItem ColSpan="1" ColumnName="caracteristica">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ServerPostgreSqlODBC %>" DeleteCommand="DELETE FROM &quot;Caracteristicas&quot; WHERE &quot;key_caracteristicas&quot; = ?" InsertCommand="INSERT INTO &quot;Caracteristicas&quot; (caracteristica) VALUES (?)" ProviderName="<%$ ConnectionStrings:ServerPostgreSqlODBC.ProviderName %>" SelectCommand="SELECT key_caracteristicas, caracteristica FROM &quot;Caracteristicas&quot; ORDER BY key_caracteristicas DESC" UpdateCommand="UPDATE &quot;Caracteristicas&quot; SET caracteristica = ? WHERE key_caracteristicas = ?">
                    <DeleteParameters>
                        <asp:Parameter Name="key_caracteristicas" Type="Int64" />
                    </DeleteParameters>
                    <InsertParameters>
