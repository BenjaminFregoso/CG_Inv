...
{
    public partial class Rango_Tallas : System.Web.UI.Page
    {
        ...
        protected void ASPxGridView1_RowUpdated(object sender, DevExpress.Web.Data.ASPxDataUpdatedEventArgs e)
        {
            ...
            objeto.Bitacora("UPDATE", e.OldValues["rango"].ToString(), e.NewValues["rango"].ToString(), usuario, "", "Articulos_tallas_rangos");
            //TERMINA BITACORA #######################
        }
        ...
        protected void ASPxGridView1_RowInserted(object sender, DevExpress.Web.Data.ASPxDataInsertedEventArgs e)
        {
            ...
            GlobalHandler objeto = new GlobalHandler();
            objeto.Bitacora("INSERT", "", e.NewValues["rango"].ToString() , usuario, "", "Articulos_tallas_rangos");
            //TERMINA BITACORA #######################
        }
        ...
        protected void ASPxGridView1_RowDeleted(object sender, DevExpress.Web.Data.ASPxDataDeletedEventArgs e)
        {
            ...
            GlobalHandler objeto = new GlobalHandler();
            objeto.Bitacora("DELETE", e.Values["rango"].ToString(), "", usuario, "", "Articulos_tallas_rangos");
            //TERMINA BITACORA #######################
        }
    }
}