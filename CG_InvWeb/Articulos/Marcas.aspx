<%@ Page Title="Marcas" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="Marcas.aspx.cs" Inherits="CG_InvWeb.Articulos.Marcas" %>
...
<div class="Principal">          
    <dx:ASPxRoundPanel ID="ASPxRoundPanel1" HorizontalAlign="Left" runat="server" HeaderText="Marcas" ShowCollapseButton="True" Theme="MaterialCompact" Width="100%" Font-Names="Century Gothic" CssClass="auto-style1" Height="100%" HeaderNavigateUrl="~/Articulos/Marcas.aspx">
        <LoadingPanelStyle HorizontalAlign="Left" VerticalAlign="Top"></LoadingPanelStyle>
        <PanelCollection>
            <dx:PanelContent runat="server">
                <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SDS_Marcas" EnableTheming="True" KeyFieldName="key_marca" Theme="MaterialCompact" KeyboardSupport="True" Width="100%" OnRowDeleted="ASPxGridView1_RowDeleted" OnRowInserted="ASPxGridView1_RowInserted" OnRowUpdated="ASPxGridView1_RowUpdated">

                    <EditFormLayoutProperties ColCount="1">
                        <Items>
                            <dx:GridViewColumnLayoutItem ColSpan="1" ColumnName="marca">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="key_marca" ShowInCustomizationForm="True" VisibleIndex="1" Caption="Código" ReadOnly="True">
                            <EditFormSettings Visible="False" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="marca" ShowInCustomizationForm="True" VisibleIndex="2" Caption="Marca">
                            <PropertiesTextEdit MaxLength="50" HelpText="Nombre de la marca (hasta 50 caracteres)" NullText="Marca">
                ...
                <asp:SqlDataSource ID="SDS_Marcas" runat="server" ConnectionString="<%$ ConnectionStrings:ServerPostgreSqlODBC %>" DeleteCommand="DELETE FROM &quot;Marcas&quot; WHERE key_marca = ?" InsertCommand="INSERT INTO &quot;Marcas&quot; (marca) VALUES ( ?)" ProviderName="<%$ ConnectionStrings:ServerPostgreSqlODBC.ProviderName %>" SelectCommand="SELECT key_marca, marca FROM &quot;Marcas&quot;" UpdateCommand="UPDATE &quot;Marcas&quot; SET marca = ? WHERE key_marca = ?">
                    <DeleteParameters>
                        <asp:Parameter Name="key_marca" Type="Int64" />
                    </DeleteParameters>
                    <InsertParameters>
