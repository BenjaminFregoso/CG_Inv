...
namespace CG_InvWeb.Compras
{
    ...
    public partial class Proveedores : System.Web.UI.Page
    {
        ...
        {
            Session["session_key_proveedores"] = (sender as ASPxGridView).GetMasterRowKeyValue();
        }
        ...
        protected void ASPxGridView1_BeforeGetCallbackResult(object sender, EventArgs e)
        {
            ...
            if (grid.IsNewRowEditing)
                grid.SettingsText.PopupEditFormCaption = "Agregar || Proveedores";
            else
                grid.SettingsText.PopupEditFormCaption = "Editar  || Proveedores";

        }

        protected void ASPxGridView2_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            e.NewValues["fkey_proveedores"] = Session["session_key_proveedores"];
        }
