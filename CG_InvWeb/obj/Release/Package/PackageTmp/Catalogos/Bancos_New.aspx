...
<div class="Principal">          
    <dx:ASPxRoundPanel ID="ASPxRoundPanel1" HorizontalAlign="Left" runat="server" HeaderText="Bancos" ShowCollapseButton="True" Theme="iOS" Width="100%" Font-Names="Century Gothic" CssClass="auto-style1" Height="100%" HeaderNavigateUrl="~/Catalogos/Bancos_New.aspx">
        <LoadingPanelStyle HorizontalAlign="Left" VerticalAlign="Top"></LoadingPanelStyle>
        <PanelCollection>
            <dx:PanelContent runat="server">                
    

                <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EnableTheming="True" KeyFieldName="key_banco" Theme="MaterialCompact" KeyboardSupport="True" Width="100%" OnRowDeleted="ASPxGridView1_RowDeleted" OnRowInserted="ASPxGridView1_RowInserted" OnRowUpdated="ASPxGridView1_RowUpdated">


                    <EditFormLayoutProperties>
                        <Items>
                            <dx:GridViewColumnLayoutItem ColSpan="1" ColumnName="banco">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="key_banco" ReadOnly="True" ShowInCustomizationForm="True" Visible="False" VisibleIndex="1">
                            <EditFormSettings Visible="False" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Banco" FieldName="banco" ShowInCustomizationForm="True" VisibleIndex="2">
                            <PropertiesTextEdit MaxLength="3" HelpText="Código del banco (hasta 3 caracteres)" NullText="Código del Banco">
                        ...
                        <dx:GridViewDataTextColumn Caption="Descripción" FieldName="descrip" ShowInCustomizationForm="True" VisibleIndex="3">
                            <PropertiesTextEdit MaxLength="100" HelpText="Nombre del Banco (hasta 100 caracteres)" NullText="Nombre de Banco">
                                <ValidationSettings SetFocusOnError="True">
                                    <RequiredField IsRequired="True" />
                                </ValidationSettings>
                            </PropertiesTextEdit>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ServerPostgreSqlODBC %>" DeleteCommand="DELETE FROM &quot;c_Bancos&quot; WHERE key_banco = ?" InsertCommand="INSERT INTO &quot;c_Bancos&quot; ( banco, descrip) VALUES ( ?, ?)" ProviderName="<%$ ConnectionStrings:ServerPostgreSqlODBC.ProviderName %>" SelectCommand="SELECT key_banco, banco, descrip FROM &quot;c_Bancos&quot; ORDER BY key_banco DESC" UpdateCommand="UPDATE &quot;c_Bancos&quot; SET descrip = ? WHERE key_banco = ?">
                    <DeleteParameters>
