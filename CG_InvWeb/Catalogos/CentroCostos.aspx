<%@ Page Title="Centro de Costos" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="CentroCostos.aspx.cs" Inherits="CG_InvWeb.Catalogos.CentroCostos" %>
...
<div class="Principal">          
    <dx:ASPxRoundPanel ID="ASPxRoundPanel1" HorizontalAlign="Left" runat="server" HeaderText="Centros de costos" ShowCollapseButton="True" Theme="MaterialCompact" Width="100%" Font-Names="Century Gothic" CssClass="auto-style1" Height="100%" HeaderNavigateUrl="~/Catalogos/CentroCostos.aspx">
        <LoadingPanelStyle HorizontalAlign="Left" VerticalAlign="Top"></LoadingPanelStyle>
        <PanelCollection>
            <dx:PanelContent runat="server">                    
                <dx:ASPxGridView  ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EnableTheming ="True" KeyFieldName="key_centrocostos" Theme="MaterialCompact" KeyboardSupport="True" Width="100%" OnRowInserting="ASPxGridView1_RowInserting" OnInitNewRow="ASPxGridView1_InitNewRow" OnCustomErrorText="ASPxGridView1_CustomErrorText" OnRowDeleted="ASPxGridView1_RowDeleted" OnRowInserted="ASPxGridView1_RowInserted" OnRowUpdated="ASPxGridView1_RowUpdated">
                    <SettingsPopup>
                    ...
                    <EditFormLayoutProperties ColCount="1">
                        <Items>
                            <dx:GridViewColumnLayoutItem ColSpan="1" ColumnName="centrocostos">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="key_centrocostos" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="1" Visible="False">
                            <EditFormSettings Visible="False" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="centrocostos" ShowInCustomizationForm="True" VisibleIndex="3" Caption="Centro de Costos">
                            <PropertiesTextEdit MaxLength="100" HelpText="Nombre del centro de costos (100 caracteres)" NullText="Nombre del Centro de Costos">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ServerPostgreSqlODBC %>" DeleteCommand="DELETE FROM &quot;CentroCostos&quot; WHERE &quot;key_centrocostos&quot; = ?" InsertCommand="INSERT INTO &quot;CentroCostos&quot; (&quot;centrocostos&quot;) VALUES (?)" ProviderName="<%$ ConnectionStrings:ServerPostgreSqlODBC.ProviderName %>" SelectCommand="SELECT &quot;key_centrocostos&quot;, &quot;centrocostos&quot; FROM &quot;CentroCostos&quot; ORDER BY key_centrocostos DESC" UpdateCommand="UPDATE &quot;CentroCostos&quot; SET centrocostos = ? WHERE key_centrocostos = ?">
                    <DeleteParameters>
                        <asp:Parameter Name="key_centrocostos" Type="Int64" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="centrocostos" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="centrocostos" Type="String" />
                        <asp:Parameter Name="key_centrocostos" Type="Int64" />
