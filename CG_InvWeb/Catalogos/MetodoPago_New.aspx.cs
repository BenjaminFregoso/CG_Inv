...
{
    public partial class MetodoPago_New : System.Web.UI.Page
    {
        ...
        protected void ASPxGridView1_RowDeleted(object sender, DevExpress.Web.Data.ASPxDataDeletedEventArgs e)
        {
            ...
            objeto.Bitacora("DELETE", e.Values["metodo_pago"].ToString() + " -- " + e.Values["descrip"].ToString(), "", usuario, "", "c_Metodo_Pago");
            //TERMINA BITACORA #######################
        }
        ...
        protected void ASPxGridView1_RowInserted(object sender, DevExpress.Web.Data.ASPxDataInsertedEventArgs e)
        {
            ...
            GlobalHandler objeto = new GlobalHandler();
            objeto.Bitacora("INSERT", "", e.NewValues["metodo_pago"].ToString() + " -- " + e.NewValues["descrip"].ToString(), usuario, "", "c_Metodo_Pago");
            //TERMINA BITACORA #######################
        }
        ...
        protected void ASPxGridView1_RowUpdated(object sender, DevExpress.Web.Data.ASPxDataUpdatedEventArgs e)
        {
            ...
            GlobalHandler objeto = new GlobalHandler();
            objeto.Bitacora("UPDATE", e.OldValues["metodo_pago"].ToString() + " -- " + e.OldValues["descrip"].ToString(), e.NewValues["metodo_pago"].ToString() + " -- " + e.NewValues["descrip"].ToString(), usuario, "", "c_Metodo_Pago");
            //TERMINA BITACORA #######################
        }
    }
}