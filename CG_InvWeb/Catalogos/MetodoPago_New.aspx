<%@ Page Title="Metodo de Pago" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="MetodoPago_New.aspx.cs" Inherits="CG_InvWeb.Catalogos.MetodoPago_New" %>
        ...
        <PanelCollection>
            <dx:PanelContent runat="server">
                ...
                <dx:ASPxGridView ID="ASPxGridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EnableTheming="true" KeyFieldName="key_metodo_pago" Theme="MaterialCompact" KeyboardSupport="True" Width="100%" OnRowDeleted="ASPxGridView1_RowDeleted" OnRowInserted="ASPxGridView1_RowInserted" OnRowUpdated="ASPxGridView1_RowUpdated" >
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="key_metodo_pago" ReadOnly="True" ShowInCustomizationForm="True" Visible="False" VisibleIndex="0">
                            <EditFormSettings Visible="False" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Codigo" FieldName="metodo_pago" ShowInCustomizationForm="True" VisibleIndex="1">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Metodo de Pago" FieldName="descrip" ShowInCustomizationForm="True" VisibleIndex="2">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn Caption="Fecha Inicial" FieldName="fecha_ini" ShowInCustomizationForm="True" VisibleIndex="3">
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataDateColumn Caption="Fecha Final" FieldName="fecha_fin" ShowInCustomizationForm="True" VisibleIndex="4">
                        </dx:GridViewDataDateColumn>
                    </Columns>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ServerPostgreSqlODBC %>" DeleteCommand="DELETE FROM &quot;c_Metodo_Pago&quot; WHERE &quot;key_metodo_pago&quot; = ?" InsertCommand="INSERT INTO &quot;c_Metodo_Pago&quot; (&quot;metodo_pago&quot;, &quot;descrip&quot;, &quot;fecha_ini&quot;, &quot;fecha_fin&quot;  ) VALUES ( ?, ?, ?, ?)" ProviderName="<%$ ConnectionStrings:ServerPostgreSqlODBC.ProviderName %>" SelectCommand="SELECT &quot;key_metodo_pago&quot;, &quot;metodo_pago&quot;, &quot;descrip&quot;,&quot;fecha_ini&quot;,&quot;fecha_fin&quot; FROM &quot;c_Metodo_Pago&quot; ORDER BY &quot;metodo_pago&quot;" UpdateCommand="UPDATE &quot;c_Metodo_Pago&quot; SET &quot;metodo_pago&quot; = ?, &quot;descrip&quot; = ?, &quot;fecha_ini&quot; = ?, &quot;fecha_fin&quot; = ?  WHERE &quot;key_metodo_pago&quot; = ?">
                    <DeleteParameters>
