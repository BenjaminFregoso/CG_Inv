...
{
    public partial class Estado_New : System.Web.UI.Page
    {
        ...
        protected void ASPxGridView1_CustomErrorText(object sender, DevExpress.Web.ASPxGridViewCustomErrorTextEventArgs e)
        {
            ...
            if (e.ErrorText.Contains("c_Estado_estado_key"))
            {
                e.ErrorText = "Ya existe el código del Estado que estás tratando de agregar";
            }
        }
        ...
        protected void ASPxGridView1_RowDeleted(object sender, DevExpress.Web.Data.ASPxDataDeletedEventArgs e)
        {
            ...
            objeto.Bitacora("DELETE", e.Values["estado"].ToString() + " -- " + e.Values["descrip"].ToString(), "", usuario, "", "c_Estado");
            //TERMINA BITACORA #######################
        }
        ...
        protected void ASPxGridView1_RowInserted(object sender, DevExpress.Web.Data.ASPxDataInsertedEventArgs e)
        {
            ...
            GlobalHandler objeto = new GlobalHandler();
            objeto.Bitacora("INSERT", "", e.NewValues["estado"].ToString() + " -- " + e.NewValues["descrip"].ToString(), usuario, "", "c_Estado");
            //TERMINA BITACORA #######################
        }
        ...
        protected void ASPxGridView1_RowUpdated(object sender, DevExpress.Web.Data.ASPxDataUpdatedEventArgs e)
        {
            ...
            GlobalHandler objeto = new GlobalHandler();
            objeto.Bitacora("UPDATE", e.OldValues["estado"].ToString() + " -- " + e.OldValues["descrip"].ToString(), e.NewValues["estado"].ToString() + " -- " + e.NewValues["descrip"].ToString(), usuario, "", "c_Estado");
            //TERMINA BITACORA #######################
        }
    }
}