...
{
    public partial class Moneda_New1 : System.Web.UI.Page
    {
        ...
        protected void ASPxGridView1_CustomErrorText(object sender, DevExpress.Web.ASPxGridViewCustomErrorTextEventArgs e)
        {
            ...
            if (e.ErrorText.Contains("c_Moneda_moneda_key"))
            {
                e.ErrorText = "Ya existe el código de Moneda que estás tratando de agregar";
            }
